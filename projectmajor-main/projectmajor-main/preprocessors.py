...
try:
    ...
    # Provide minimal stub for tf.strings operations on Windows
    class _TFStringsStub:
        @staticmethod
    ...
    tf = _TFStub()
    print("[INFO] Using TensorFlow stub - full functionality requires TensorFlow")
