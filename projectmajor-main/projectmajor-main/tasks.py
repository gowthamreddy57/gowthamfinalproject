...
# Add stubs path for Windows compatibility
...
try:
    ...
    from multilingual_t5.stubs import seqio_stub as seqio
...
try:
    ...
    from multilingual_t5.stubs import t5_stub as t5
    from multilingual_t5.stubs.t5_stub import data, evaluation
    t5.data = data
...
try:
    ...
    from multilingual_t5.stubs import tfds_stub as tfds
